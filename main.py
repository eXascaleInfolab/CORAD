...
if __name__ == "__main__":
    ...
    df_data_learning = df_data_learning.iloc[:, 0:53]
    print(df_data.shape)
    ...
    # print(len(time_series_data_dictionary[0]), len(time_series_data_dictionary[1]))
    ...
    Dictionary = learnDictionary(time_series_data_dictionary[0], 100, 1, 150, 'dict_100.pkl')
